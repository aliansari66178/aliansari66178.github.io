...
function mo (input) {
    ...
    if (input.substr(-1, 1) == "د") {
        input = input.substr(0, (input.length - 1));
        masdar = ["شنی", "آفری", "کر", "دی", "مر", "آرمی", "آرام", "گروی", "آم", "بو", "ش", "غنو", "سپر", "ایست", "ست",
        "زا", "دا", "گزی", "فشر", "درو", "افت", "ستا", "فتا", "شمر", "آجی", "آز", "آگهی", "آما", "آزر",
        "انبو", "گشا", "چی"]
        bon = ["شنو", "آفرین", "کن", "بین", "میر", "آرام", "آرام", "گرای", "آی", "باش", "شو", "غنو", "سپار", "ایست", "ستان",
