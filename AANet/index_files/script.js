...
setInterval(sgr, 1);
function sgr () {
  gravity = document.getElementById("gr").value;
  accuracy = document.getElementById("ac").value;
  tearDist = document.getElementById("td").value;
  friction = document.getElementById("fr").value;
}
//AA
